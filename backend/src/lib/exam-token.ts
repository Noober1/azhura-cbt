 ...
 * supply a token that matches exactly (case-sensitive) and is alphanumeric,
 ...
 * - `mismatch`       — well-formed token that does not match (case-sensitive).
 */
...
export const checkExamToken = (
  ...
  // Exact, case-sensitive comparison — "Ab12c" !== "ab12c".
  return provided === examToken ? "ok" : "mismatch";
};
