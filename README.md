...
5. **Anti-Cheat Engine** (epic #24, berlapis):
   ...
   - **L3 — OS Keyboard Hook (Windows)** — `WH_KEYBOARD_LL` menelan Alt+Tab, Alt+Esc, Win, Ctrl+Esc, dan PrintScreen di level OS selama ujian (`VITE_ANTI_CHEAT_BLOCK_OS_KEYBOARD`).
