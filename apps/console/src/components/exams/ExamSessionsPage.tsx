  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      {sessions.length === 0 ? (
        ...
        <div className="mt-6 overflow-hidden rounded-[var(--radius-card)] border-[2.5px] border-[var(--nb-ink)] shadow-[3px_3px_0_var(--nb-ink)]">
          <table className="w-full text-sm">
            <thead className="border-b-[2.5px] border-[var(--nb-ink)] bg-highlight">
              <tr>
                ...
                <th className="px-4 py-2.5 text-right text-xs font-extrabold uppercase tracking-wider text-ink">Aksi</th>
              </tr>
            </thead>
