      ...
      <AlertDialogContent size="default" className="p-6">
        <AlertDialogHeader>
          <AlertDialogTitle className="text-xl font-bold text-foreground flex items-center gap-2">
            <span className="grid size-9 shrink-0 place-items-center rounded-lg border-2 border-[var(--nb-ink)] bg-amber"><TriangleAlert className="w-5 h-5 text-foreground" /></span>
        ...
        <div className="my-4 p-4 rounded-xl border-2 border-[var(--nb-ink)] bg-muted/50 space-y-2">
        ...
        <div className="flex items-start gap-2.5 rounded-xl border-2 border-[var(--nb-ink)] bg-amber px-3.5 py-3 text-foreground shadow-[2px_2px_0_var(--nb-ink)]">
